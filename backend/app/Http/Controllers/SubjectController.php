...
class SubjectController extends Controller
{
    ...
    {
        $this->mediaType = new SubjectRepository;
    }
    ...
    function getSubject(Request $request)
    {
        ...
        if (count($data) == 0) {
            ...
            return response([
                'status' => true,
                'data' => $data,
                'message' => "All Data Active Subject"
            ]);
        }
    }
    ...
    function getSingleSubject(Request $request, $id)
    {
